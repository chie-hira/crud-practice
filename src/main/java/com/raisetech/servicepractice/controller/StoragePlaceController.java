...
public class StoragePlaceController {
    ...
    public ResponseEntity<StoragePlaceResponse> insert(@RequestBody @Valid StoragePlaceRequest storagePlaceRequest, UriComponentsBuilder uriComponentsBuilder){
        StoragePlace storagePlace = storagePlaceService.insert(storagePlaceRequest.getStorageDate(), storagePlaceRequest.getStoragePlace(), storagePlaceRequest.getUserId(), storagePlaceRequest.getMaterialId());
